...
<div class="form-group">
    ...
    <input type="text" id="name" name="name" class="form-control" value="<?= isset($post) ? htmlspecialchars($post->get('name')): ''; ?>">
    <p><?= isset($errors['name']) ? $errors['name'] : ''; ?></p>
</div>

<div class="form-group">
    <label for="mail">Votre email</label>
    <input type="text" id="mail" name="mail" class="form-control" value="<?= isset($post) ? htmlspecialchars($post->get('mail')): ''; ?>">
